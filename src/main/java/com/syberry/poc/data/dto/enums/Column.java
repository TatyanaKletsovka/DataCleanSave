...
public enum Column {
  ...
  FULL_DATE(List.of(new Tag[]{Tag.STRING, Tag.FULL_DATE})),
  DATE(List.of(new Tag[]{Tag.STRING, Tag.DATE})),
  HOUR(List.of(new Tag[]{Tag.STRING, Tag.TIME})),
  ...
  DIR(List.of(new Tag[]{Tag.STRING})),
